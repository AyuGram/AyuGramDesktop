...
#endif
	AyuAssets::DEFAULT_ICON,	   AyuAssets::ALT_ICON,		AyuAssets::DISCORD_ICON, AyuAssets::SPOTIFY_ICON,
	AyuAssets::EXTERA_ICON,		   AyuAssets::NOTHING_ICON, AyuAssets::BARD_ICON,	 AyuAssets::YAPLUS_ICON,
	AyuAssets::WIN95_ICON,		   AyuAssets::CHIBI_ICON,	AyuAssets::CHIBI2_ICON,
};

const auto rows = static_cast<int>(icons.size()) / 4 + std::min(1, static_cast<int>(icons.size()) % 4);

void
drawIcon(QPainter& p, const QImage& icon, int xOffset, int yOffset, float strokeOpacity) {
...
void
IconPicker::paintEvent(QPaintEvent* e) {
	Painter p(this);
...
void
IconPicker::mousePressEvent(QMouseEvent* e) {
