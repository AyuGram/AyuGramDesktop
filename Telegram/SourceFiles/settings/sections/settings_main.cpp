...
[[nodiscard]] QString CreditsAmountToLabel(CreditsAmount c) {
	return c ? Lang::FormatCreditsAmountToShort(c).string : QString();
}

[[nodiscard]] bool CreditsAmountNonEmpty(CreditsAmount c) {
	return !c.empty();
}
